...
Item{
    ...
    states: [
        ...
        State {
            ...
            PropertyChanges { target: btn; border.color: borderColorHover; }
        ...
        State {
            ...
            PropertyChanges { target: btn; border.color: borderColorPress; }
    ...
    transitions: [
        Transition {
            ...
            PropertyAnimation{property:"opacity" ; duration: 200; from:0.0; to: 1.0}
        },
        Transition {
            from: "hover" ; to :"normal";
            PropertyAnimation{property:"opacity" ; duration: 200; from:1.0; to: 0.0}
        }
    ]
